...
Question 3: What would a violin plot of residuals from the linear model in Question 3 vs. year look like? (Again, don’t do the analysis yet, answer this intuitively)
...
Taxi information for November of 2018. This is a secondry data set needed to the machine learning part of the project. 
...
We are going to use machine learning to answer this question and the method that we are going to use is a random forest with 50 tress.
